...
class TopDownTest(Engine):
    ...
    def setup(self):
        ...
        scene.entity_manager.add_component(eid, Transform(x=0,y=0))
        ...
        scene.entity_manager.add_component(eid, TopDownCarController(11, 1))
