...
import math
from zengine.core import config
...
def main():
    ...
    texture, tex_w, tex_h = load_texture("assets/images/mech1.png") # Definitely move all this out of here after testing
    ...
    # state:
    position = [0,0]  # world-space position
    ...
    while True:
        ...
        for e in pygame.event.get():
            if e.type in (pygame.QUIT, pygame.KEYDOWN) and getattr(e, 'key', None)==pygame.K_ESCAPE:
                pygame.quit()
                return
