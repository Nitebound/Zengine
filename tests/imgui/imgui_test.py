...
imgui_renderer = BaseOpenGLRenderer()
...
while running:
    ...
    user_entry = imgui.input_text("Input text", "default text")

    if user_entry != "":
        print(f"Input text changed to: {user_entry}")

    imgui.slider_float("Slider", 0.0, 1.0, 100)
